...
const ClientViewNav = ({ clientData }) => {
  ...
  return (
    // <div className="bg-slate-100 w-1/6 h-screen">
    <div
      id="Main"
    ...
    >
      ...
      <div className="flex flex-col justify-start items-center px-6 w-full  ">
        ...
        >
          <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-sky-600 focus:text-slate-100 hover:bg-sky-300 text-slate-600 rounded px-3 py-3 w-full md:w-52">
            <FaWindowMaximize className=" text-indigo-500" />
            <p className="text-base leading-4  ">Dashboard</p>
          </button>
          <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-sky-600 focus:text-slate-100 hover:bg-sky-300 text-slate-600 rounded px-3 py-3 3w-full md:w-52">
